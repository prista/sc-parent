...
class DefaultProductServiceTest {
    ...
    @InjectMocks
    DefaultProductService underTest;
    ...
    void findAllProducts_FilterIsNotSet_ReturnsProductsList() {
        ...
        // when
        var result = this.underTest.findAllProducts(null);
    ...
    void findAllProducts_FilterIsSet_ReturnsFilteredProductsList() {
        ...
        // when
        var result = this.underTest.findAllProducts("товар");
    ...
    void findProduct_ProductExists_ReturnsNotEmptyOptional() {
        ...
        // when
        var result = this.underTest.findProduct(1);
    ...
    void createProduct_ReturnsCreatedProduct() {
        ...
        // when
        var result = this.underTest.createProduct(title, details);
    ...
    void updateProduct_ProductExists_UpdatesProduct() {
        ...
        // when
        this.underTest.updateProduct(productId, title, details);
    ...
    void updateProduct_ProductDoesNotExist_ThrowsNoSuchElementException() {
        ...
        // when
        assertThrows(NoSuchElementException.class, () -> this.underTest
    ...
    void deleteProduct_DeletesProduct() {
        ...
        // when
        this.underTest.deleteProduct(productId);
