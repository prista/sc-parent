...
class OAuthClientHttpRequestInterceptorTest {
    ...
    OAuthClientHttpRequestInterceptor underTest;

    @BeforeEach
    void setUp() {
        this.underTest = new OAuthClientHttpRequestInterceptor(this.authorizedClientManager, "test");
    }
    ...
    void intercept_AuthorizationHeaderIsNotSet_AddsAuthorizationHeader() throws IOException {
        ...
        // when
        var result = this.underTest.intercept(request, body, execution);
